...
import ElectritrackImage from '../img/Electritrack.png';
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        />
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square sx={{ backgroundColor: '#FF9843' }}>
          <Box
            sx={{
              my: 8,
              mx: 4,
